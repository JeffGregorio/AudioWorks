...
typedef enum PinchZoomMode {
    kMETScopeViewPinchZoomHoldCenter,
    kMETScopeViewPinchZoomHoldMin,
    kMETScopeViewPinchZoomHoldMax
} PinchZoomMode;
...
@interface METScopeView : UIView <UIGestureRecognizerDelegate> {
    ...
    /* Pinch zoom (x-axis only) */
    UIPinchGestureRecognizer *pinchRecognizer;
    CGFloat previousPinchScale;
    
    /* Pan gesture (x-axis only) */
...
@property (readonly, getter=hasCurrentPinch) bool currentPinch;
@property (readonly, getter=hasCurrentPan)   bool currentPan;
...
@property PinchZoomMode pinchZoomMode;  // Expand/contract left/right/center
@property (readonly) bool pinchZoomEnabled;
@property (readonly) bool panEnabled;
...
/* Add/Remove the built-in gesture recognizers */
